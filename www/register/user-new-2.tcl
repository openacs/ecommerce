...
if { !$double_click_p } {
	...
	ns_sendmail $email $notification_address "Welcome to [ad_system_name]" "To confirm your registration, please go to [ad_url]/register/email-confirm.tcl?[export_url_vars row_id]"

...
ad_page_contract {
  ...
  @author
  @creation-date
  @cvs-id add-2.tcl,v 3.2.2.6 2000/09/22 01:35:03 kevin Exp
...
[ad_admin_context_bar [list "../" "Ecommerce([ec_system_name])"] [list "index.tcl" "Product Templates"] "Confirm Template"]

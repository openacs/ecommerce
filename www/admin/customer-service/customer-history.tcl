...
append doc_body "[ad_admin_header "Customer History"]
...
db_foreach get_customer_interaction_detail $sql {
    ...
    append doc_body "<tr bgcolor=\"$bgcolor\"><td><a href=\"customer-history?customer_type=$customer_type&customer_id=${customer_id}&interaction_id=$interaction_id\">$interaction_id</a></td>

...
ad_page_contract {  
    ...
    @author
    @creation-date
    @cvs-id picklist-item-add.tcl,v 3.1.6.4 2000/09/22 01:34:53 kevin Exp
...
[ad_admin_context_bar [list "../index.tcl" "Ecommerce([ec_system_name])"] [list "index.tcl" "Customer Service Administration"] [list "picklists.tcl" "Picklist Management"] "Add an Item"]

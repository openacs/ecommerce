...
set row_counter 0
set order_select_html ""
db_foreach orders_select "select o.order_id, o.confirmed_date, o.order_state, ec_total_price(o.order_id) as price_to_display, o.user_id, u.first_names, u.last_name, count(*) as n_items
	...
	if { $row_counter == 0 } {
	    append order_select_html $table_header
	} elseif { $row_counter == 20 } {
	    append order_select_html "</table> <br> $table_header"
	    set row_counter 1
	}
	...
	append order_select_html "<tr bgcolor=\"$bgcolor\">
...
if { $row_counter != 0 } {
    append order_select_html "</table>"
} else {
    append order_select_html "<center>None Found</center>"
}

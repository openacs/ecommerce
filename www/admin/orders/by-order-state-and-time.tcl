# /www/[ec_url_concat [ec_url] /admin]/orders/by-order-state-and-time.tcl
ad_page_contract {
...
doc_body_append "[ad_admin_header "Order History"]
...
doc_body_append "\[ [join $linked_confirmed_list " | "] \]

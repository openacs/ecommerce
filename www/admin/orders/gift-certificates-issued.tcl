# /www/[ec_url_concat [ec_url] /admin]/orders/gift-certificates-issued.tcl
ad_page_contract {
  ...
  @cvs-id gift-certificates-issued.tcl,v 3.2.2.3 2000/08/16 21:07:10 seb Exp
...
doc_body_append "[ad_admin_header "Gift Certificate Issue History"]

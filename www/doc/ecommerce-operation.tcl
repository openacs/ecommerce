ad_page_contract {
    ...
    The operation guide to the ecommerce package, a package to implement
...
set title "$package_name Documentation: Operation"
set package_url [apm_package_url_from_key "ecommerce"]

# Set the context bar.

set context_bar [ad_context_bar [list "." "$package_name Documentation"] "Operation"]

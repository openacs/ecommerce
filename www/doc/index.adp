...
<master>
  ...
  <p>In addition to the standard shopping cart and real-time credit
    ...
    and online reporting, among other features detailed in the overview
    below.</p>

  <ol>
    <li>Two overviews:  <a href="ecommerce-for-mbas">for MBAs</a> | <a href="ecommerce-features">feature-by-feature</a></li>
    <li><a href="ecommerce-setup">Setting up @package_name@</a></li>
    <li><a href="ecommerce-operation">Operation of @package_name@</a></li>
  ...
  <p>@package_name@ is distributed in the hope that it will be

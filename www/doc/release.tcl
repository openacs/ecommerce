ad_page_contract {
    ...
    Release documentation of the ecommerce package, a package to implement
...
set title "$package_name Documentation: 4.1a Release notes"
...
set context_bar [ad_context_bar [list "." "$package_name Documentation"] "4.1a Release notes"]

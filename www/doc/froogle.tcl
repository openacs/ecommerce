ad_page_contract {
    ...
    Froogle documentation of the ecommerce package, a
...
set title "$package_name Documentation: Froogle data feed"
set package_url [apm_package_url_from_key "ecommerce"]

# Set the context bar.

set context_bar [ad_context_bar [list "." "$package_name"] "Froogle"]

...
<queryset>
  ...
  <fullquery name="ec_unauthorized_transactions.problems_log_insert">      
    <querytext>
      ...
      (problem_id, problem_date, problem_details, order_id)
      values
      (ec_problem_id_sequence.nextval, current_timestamp, 'invalid input to ec_creditcard_authorization in ec_unauthorized_transactions', :order_id)
    </querytext>
  </fullquery>
  ...
  <fullquery name="ec_unrefund_settled_transactions.problems_log_insert">
    <querytext>
      insert into ec_problems_log
      (problem_id, problem_date, problem_details, order_id)
      values

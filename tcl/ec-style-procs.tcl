...
ad_proc ec_register_styletag {
    ...
    ad_proc $generated_proc_name  {{string ""} {tagset ""}} "Proc generated by ec_register_styletag to support the $tagname ADP tag." $proc_body

    # let's register the ADP tag now
    ns_register_adptag $tagname "/$tagname" $generated_proc_name

    # Store the tag and the script for later reference by doc/styles and doc/style-one
    nsv_set ec_styletag $tagname $tag_documentation
    nsv_set ec_styletag_source_file $tagname  [info script]
}
...
ad_proc ec_style_template_root {} { caches template root } {
...
ad_proc ec_style_language_from_cookie {} { returns language preference from cookie } {
...
ad_proc ec_style_plain_fancy_from_cookie {} { returns fancy or text only preference from cookie } {
    set headers [ns_conn headers]
    set cookie [ns_set get $headers Cookie]
...
ad_proc ec_style_user_preferences_from_db {user_id} {
...
ad_proc ec_style_score_templates {template_filename_list} { 
...
ad_proc ec_style_sort_by_score {l1 l2} { sorts by score } {

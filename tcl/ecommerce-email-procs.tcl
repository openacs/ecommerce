...
ad_library {
  ...
  @cvs-id ecommerce-email.tcl,v 3.4.2.7 2000/08/17 17:37:15 seb Exp
...
#      set order_link "[ec_secure_location][ec_url_concat [ec_url] /admin]/orders/one?[export_url_vars order_id]"
#    } else {
#      set order_link "[ec_insecure_location][ec_url_concat [ec_url] /admin]/orders/one?[export_url_vars order_id]"
#    }
